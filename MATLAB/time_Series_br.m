...
net.inputs{1}.processFcns = {'removeconstantrows','mapminmax'}; % Change as per assignment
net.inputs{2}.processFcns = {'removeconstantrows','mapminmax'};% Change as per assignment
