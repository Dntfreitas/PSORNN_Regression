...
brazil_data=readtable('./datasets/traffic.csv'); %Load the excel file
...
%% Milk Production
milk_prod=readtable('./datasets/milk.csv'); %Load the excel file
...
%% Wine Quality
wine_quality_red=readtable('./datasets/winered.csv');  %Load the excel file
...
%white wine
wine_quality_white=readtable('./datasets/winewhite.csv'); %Load the excel file
% Splitting the data into dependent(Y) and independent(X)
...
%% qsar fish toxicity
qsar_fish_tox=readtable('./datasets/fish.csv');%Load the excel file
% Splitting the data into dependent(Y) and independent(X)
